...
export class TodoListItemComponent implements OnInit, OnDestroy
{
    ...
    toggleStar(event): void
    {
        ...
        this._todoService.toggleStatusOnTodo('Destacada', this.todo, 'title');
        this._todoService.updateTodo(this.todo, true);
    }
    ...
    toggleImportant(event): void
    {
        ...
        this._todoService.toggleStatusOnTodo('Priorizada', this.todo, 'title');
        this._todoService.updateTodo(this.todo, true);
    }
    ...
    toggleCompleted(event): void
    {
        ...
        this._todoService.toggleStatusOnTodo('Atendida', this.todo, 'title');
        this._todoService.updateTodo(this.todo, true);
    }
}
